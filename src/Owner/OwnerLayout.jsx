...
const NAV_ITEMS = [
  ...
  { path:"/dashboard/bookings",icon:"📅", label:"Lịch đặt sân",   badge:12 },
  { path:"/dashboard/customers",icon:"👥",label:"Khách hàng",     badge:null },
  { path:"/dashboard/staff",   icon:"🛠️", label:"Nhân viên",      badge:null },
  { path:"/dashboard/settings",icon:"⚙️", label:"Cài đặt",        badge:null },
];
